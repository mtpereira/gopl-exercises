...
import (
	...
	mypopcount "gopl-exercises/ch2/popcount"
)
...
func BenchmarkPopCountLoop(b *testing.B) {
	for i := 0; i < b.N; i++ {
		mypopcount.Loop(0x1234567890ABCDEF)
	}
}

func BenchmarkPopCountShift(b *testing.B) {
	for i := 0; i < b.N; i++ {
		mypopcount.Shift(0x1234567890ABCDEF)
	}
}

func BenchmarkPopCountClearing(b *testing.B) {
	for i := 0; i < b.N; i++ {
		mypopcount.Clearing(0x1234567890ABCDEF)
	}
}
...
// BenchmarkBitCount-4                  500000000         popcount.36 ns/op
// BenchmarkPopCountByClearing-4        50000000         34.popcount ns/op
// BenchmarkPopCountByShifting-4        20000000        108 ns/op
//
// Go 1.7, popcount.5GHz Xeon
// $ go test -cpu=4 -bench=. gopl.io/ch2/popcount
